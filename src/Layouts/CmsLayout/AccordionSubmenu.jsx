...
const AccordionSubmenu = ({ items, keepOthersOpen }) => {
                ...
                {item.submenu.map((sub, subIndex) => (
                  <>
                    ...
                    <Link
                      key={subIndex}
                      to={sub.to}
                      className="block text-sm text-gray-600 dark:text-gray-300 px-4 py-2 ml-2 rounded transition-all hover:pl-6 hover:text-green-500 hover:bg-gray-100 dark:hover:bg-gray-800"
                    >
                      {sub.label}
                    </Link>
                  </>
