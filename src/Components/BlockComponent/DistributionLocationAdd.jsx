...
const DistributionLocationAdd = ({ addLocation, onClose }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-950 rounded-lg shadow-2xl w-full max-w-2xl overflow-hidden border border-gray-100 dark:border-gray-800 transition-all">
      {/* Header */}
      <div className="relative p-8 bg-gradient-to-br from-indigo-600 via-blue-600 to-blue-700 dark:from-indigo-900 dark:to-blue-900">
        <div className="relative z-10 flex items-center gap-5">
          ...
          <div>
            ...
            <p className="text-blue-100/80 text-sm font-medium">
              Setup a new distribution hub for the current phase.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            <div className="space-y-1">
              ...
              <div className="relative group">
                <TextInput
                  id="locName"
                  placeholder="e.g. Block Warehouse A"
            ...
            <div className="space-y-1 md:col-span-2">
              ...
              <TextInput
                id="bdoContact"
                maxLength={10}
                placeholder="Direct line for BDO"
                {...register("bdoContact", {
