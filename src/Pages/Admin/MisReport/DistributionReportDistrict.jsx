...
const DistributionReportDistrict = () => {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      if (response.error) {
        ...
        const filename = `District_Wise_Distribution_${phaseDetails.phaseName}_${timestamp}.xlsx`;
                  ...
                  <>
                    {data.map((value, index) => (
                      ...
                      >
                        <td className="p-5">
                          <Link
                            to={`/DistributionReportBlock/${btoa(value.dist_id_pk)}`}
