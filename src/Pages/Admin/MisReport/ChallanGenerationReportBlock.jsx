...
const ChallanGenerationReportBlock = () => {
  ...
  // Memoized totals for performance and cleaner JSX
      ...
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-4 md:p-8 transition-colors duration-500">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">
            Block-wise <span className="text-indigo-500">Report</span>
          </h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1 font-medium flex items-center gap-2">
            <Info size={16} className="text-indigo-500" />
            Phase {phaseDetails.phaseName} • Detailed Block Analysis
          </p>
        </div>
                  ...
                  <>
                    {data.map((value, index) => (
                      ...
                      >
                        ...
                        <td className="p-4">
                          <Link
                            to={`/ChallanGenerationReportSchool/${btoa(value.block_id_pk)}`}
