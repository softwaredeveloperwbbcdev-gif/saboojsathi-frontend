...
const DistributionReportSchool = () => {
  ...
  // Note: Using 'boys_updated' and 'girls_updated' as per your secondary snippet
  ...
  const handleDownload = async () => {
    ...
    try {
      const response = await callApi(
        "POST",
        `schoolwise_distribution_report_download`,
        { phaseId, id },
        { responseType: "blob" },
      );
      if (response.error) {
        ...
        const filename = `School_Wise_Distribution_${phaseDetails.phaseName}_${phaseDetails.year}_${timestamp}.xlsx`;
      ...
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-4 md:p-8 transition-colors duration-500">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400 mt-1 font-medium flex items-center gap-2">
              ...
              Phase {phaseDetails.phaseName} • School Level Details
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <StatMiniCard
            ...
            value={data.length ? Math.round(totals.genTotal / data.length) : 0}
            icon={School}
...
export default DistributionReportSchool;
