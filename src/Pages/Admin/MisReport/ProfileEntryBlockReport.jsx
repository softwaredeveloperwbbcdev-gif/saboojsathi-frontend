  ...
  return (
    <AdminAuthenticatedLayout>
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-4 md:p-8 transition-colors duration-500">
        ...
        >
          <ArrowLeft size={16} /> Back to District Report
        </Link>

        {/* Header Section */}
        <div className="mb-8">
          <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">
            Block Wise <span className="text-indigo-500">Profile Entry</span>
          </h1>
                  ...
                  <>
                    {data.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="p-5">
                          <Link
                            to={`/ProfileEntrySchoolReport/${btoa(item.block_id_pk)}`}
