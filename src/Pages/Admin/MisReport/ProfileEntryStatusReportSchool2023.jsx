...
import { profileEntryStatusSchool2023 } from "../../../Services/ApiCall";
import { useParams } from "react-router-dom";

const ProfileEntryStatusReportSchool2023 = ({ phaseName = "X" }) => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      setLoading(true);
      const response = await profileEntryStatusSchool2023(
        `profile-entry-status-school-report-2023/${year}/${id}`
      ); // API call
...
export default ProfileEntryStatusReportSchool2023;
