...
const BlockChallanReport = () => {
  ...
  // Memoized totals for summary cards and grand total row
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
          <div>
            <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">
              Block Wise <span className="text-indigo-500">Challan Report</span>
            </h1>
              ...
              <tbody className="divide-y divide-slate-50 dark:divide-slate-800">
                {data.length === 0 ? (
                  <tr>
                    ...
                    >
                      No block records available for this phase.
                    </td>
                  </tr>
                ) : (
                  <>
                    {data.map((value, index) => (
                      ...
                      >
                        ...
                        <td className="p-5">
                          <Link
                            to={`/ChallanDetailsByBlock/${btoa(value.block_id)}`}
                            className="text-sm font-black text-slate-700 dark:text-slate-200 hover:text-indigo-500 transition-colors"
                          >
                            {value.block_name}
                          </Link>
                        </td>
