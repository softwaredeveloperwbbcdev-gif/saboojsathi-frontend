...
function EligibleStudentReportBlock() {
  const { id } = useParams(); // District ID from URL
  ...
  // Memoized totals for performance and the stat cards
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      if (response.error) {
        ...
        const filename = `Block_Wise_Eligible_Students_Phase_${phaseDetails.phaseName}_${phaseDetails.year}_${timestamp}.xlsx`;
              ...
              <tbody className="divide-y divide-slate-50 dark:divide-slate-800">
                {data.length === 0 ? (
                  <tr>
                    ...
                    >
                      No records found for this district.
                    </td>
                  </tr>
                ) : (
                  <>
                    {data.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="p-5">
                          <Link
                            to={`/EligibleStudentReportSchool/${btoa(item.block_id_pk)}`}
...
export default EligibleStudentReportBlock;
