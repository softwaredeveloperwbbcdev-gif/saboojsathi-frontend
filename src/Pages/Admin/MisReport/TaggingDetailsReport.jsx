...
const TaggingDetailsReport = () => {
  ...
  // Optimized: Single pass reduction for all tagging totals
      ...
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-4 md:p-8 transition-colors duration-500">
        ...
        <div className="mb-8">
          <h1 className="text-2xl md:text-3xl font-black text-slate-900 dark:text-white tracking-tight leading-tight">
            School <span className="text-indigo-600">Tagging Report</span>
          </h1>
          <p className="text-slate-500 dark:text-slate-400 mt-2 font-medium flex items-center gap-2">
            <Info size={16} className="text-indigo-500" />
            Phase {phaseDetails.phase} • District-wise Progression (AY{" "}
            {phaseDetails.year})
          </p>
        </div>
                  ...
                  <>
                    {data.map((value, index) => (
                      ...
                      >
                        ...
                        <td className="p-4">
                          <Link
                            to={`/TaggingDetailsReportBlock/${btoa(value.dist_id_pk)}`}
...
// Internal Sub-component matched to design
